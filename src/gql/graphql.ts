...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> } | null }> } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> } | null }> } | null };

export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> } | null }> };
...
export type CartUpdateItemQuantityMutation = { updateOrderItem?: { id: string } | null };
...
export type ProductGetByIdQuery = { product?: { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> } | null };

export type ProductItemFragment = { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> };
...
export type ProductPublishMutation = { publishProduct?: { id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> } | null };
...
export type ProductsGetByCategorySlugQuery = { categories: Array<{ name: string, description?: string | null, products: Array<{ id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> }> }>, productsConnection: { pageInfo: { pageSize?: number | null } } };
...
export type ProductsGetByCollectionSlugQuery = { collections: Array<{ name: string, description?: string | null, products: Array<{ id: string, name: string, description: string, price: number, averageRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }>, reviews: Array<{ id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage }> }> }> };
...
export type ReviewCreateMutation = { createReview?: { id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage } | null };
...
export type ReviewPublishMutation = { publishReview?: { id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage } | null };

export type ReviewUpdateAverageRatingMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  averageRating?: InputMaybe<Scalars['Int']['input']>;
}>;


export type ReviewUpdateAverageRatingMutation = { updateProduct?: { id: string } | null };

export type ReviewsItemFragment = { id: string, name: string, headline: string, email: string, content: string, rating: number, stage: Stage };
...
export const ReviewsItemFragmentDoc = new TypedDocumentString(`
  ...
  stage
    ...
    `, {"fragmentName":"ReviewsItem"}) as unknown as TypedDocumentString<ReviewsItemFragment, unknown>;
...
export const ReviewUpdateAverageRatingDocument = new TypedDocumentString(`
    mutation ReviewUpdateAverageRating($id: ID!, $averageRating: Int) {
  updateProduct(where: {id: $id}, data: {averageRating: $averageRating}) {
    id
  }
}
    `) as unknown as TypedDocumentString<ReviewUpdateAverageRatingMutation, ReviewUpdateAverageRatingMutationVariables>;